...
/**
 * Classe implémentant le contrôle de <tt>core.modules.VCF</tt>.
 * 
 ...
 */
public class CVCF extends CModule {
	public CVCF() {
		super(ConcreteFactory.getAFactory().newVCF());
	}
	...
	public static void main(String...args){
		...
		ICModule cvcf = (ICModule) ConcreteFactory.getCFactory().newVCF();
